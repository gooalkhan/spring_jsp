    ...
    <div class="container py-3">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text">출판일 : <fmt:formatDate pattern="yyyy년 MM월 dd일"
            ...
            <c:forEach var="book" items="${data}" varStatus="status">
                <div class="col-sm-6 col-md-4 col-lg-2 mb-4">
                    <div class="card" style="width: 10rem">
                        <a href="?page=${page}&id=${book.bookid}"><img
                                src="https://img.ridicdn.net/cover/${book.bookid}/xlarge" class="card-img-top book-pic"
                                alt="${book.title}"></a>
        ...
        <form name="bookSearch" method="get">
            <div class="row">
                ...
                <div class="col-auto">
                    <input type="text" class="form-control" id="searchbox" name="searchword" placeholder="검색어를 입력해주세요"/>
                </div>
                <div class="col-auto">
