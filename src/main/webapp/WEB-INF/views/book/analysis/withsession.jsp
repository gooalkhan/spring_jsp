...
<div class="card mb-3 p-3">
    ...
    <div class="container d-flex justify-content-center">
        <form name="keyword-purchase" action="/keyword" method="post">
    ...
    <button class="btn btn-warning" onclick="getKeywordAnalysis('bookid=${bookid}&product=${analysis}')">ajax가져오기</button>
    </div>
    <div class="container">
