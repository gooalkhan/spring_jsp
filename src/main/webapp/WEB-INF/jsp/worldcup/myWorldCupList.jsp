        ...
        <c:if test="${sid != null}">
            ...
            <div class="container">
                ...
                <div class="col-md-5 col-lg-auto mb-3 text-center">
                    <a href="${pageContext.request.contextPath}/worldCupList" class="btn btn-outline-success">이상형 월드컵 리스트로 가기</a>
                </div>
                <div class="col-md-5 col-lg-auto mb-3 text-center">
        ...
        <c:if test="${sid == null}">
            <div class="container py-3">
                ...
                <div class="container d-flex justify-content-center">
                    <a href="${pageContext.request.contextPath}/memberLogin" class="btn btn-primary">로그인 하러 가기</a>
                </div>
            </div>
        </c:if>
    </div>
